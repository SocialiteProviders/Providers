...
Event::listen(function (\SocialiteProviders\Manager\SocialiteWasCalled $event) {
    $event->extendSocialite('constantcontact', \SocialiteProviders\ConstantContact\Provider::class);
});
```
<details>
<summary>
...
protected $listen = [
    \SocialiteProviders\Manager\SocialiteWasCalled::class => [
        // ... other providers
        \SocialiteProviders\ConstantContact\ConstantContactExtendSocialite::class.'@handle',
    ],
];
```
</details>
