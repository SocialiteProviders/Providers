...
class Provider extends AbstractProvider
{
     ...
     */
    public const IDENTIFIER = 'SALESFORCE_SANDBOX';

    public const PROVIDER_NAME = 'salesforce_sandbox';
     ...
     * If not available default to sandbox.
     *
     * @return string Salesforce base URL
     */
    private function getInstanceURL()
    {
        return $this->getConfig('instance_url', 'https://test.salesforce.com');
    }
