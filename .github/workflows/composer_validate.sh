...
composer validate --strict src/Dailymile/composer.json
...
composer validate --strict src/Everyplay/composer.json
...
composer validate --strict src/GameWisp/composer.json
...
composer validate --strict src/Hitbox/composer.json
...
composer validate --strict src/Jawbone/composer.json
...
composer validate --strict src/MasterChain/composer.json
...
composer validate --strict src/Mixer/composer.json
...
composer validate --strict src/Opskins/composer.json
...
composer validate --strict src/Rdio/composer.json
